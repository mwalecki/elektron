...
#define MIOS32_PROCESSOR_STM32F107VC
...
#  endif
# elif defined(MIOS32_PROCESSOR_STM32F107VC)
#  define PAGE_SIZE ((uint16_t)0x800)  /* Page size = 2KByte */
#  ifndef EEPROM_START_ADDRESS
#   define EEPROM_START_ADDRESS    ((uint32_t)0x0803F000)  // 2*2k at top of flash memory
#  endif
# else
